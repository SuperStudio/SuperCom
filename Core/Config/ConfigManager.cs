...
namespace SuperCom.Config
{
    public static class ConfigManager
    {
        ...
        public static CmdSettings CmdSettings { get; set; }
        public static QuickCommandSettings QuickCommandSettings { get; set; }
        ...
        static ConfigManager()
        {
            ...
            CmdSettings = CmdSettings.CreateInstance();
            QuickCommandSettings = QuickCommandSettings.CreateInstance();
        ...
        public static void InitConfig()
        {
            ...
            // 加载 QuickCommandSettings 的运行时数据
            QuickCommandSettings.Load();
        }
